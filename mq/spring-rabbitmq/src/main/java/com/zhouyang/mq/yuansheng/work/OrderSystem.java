...
public class OrderSystem {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        for (int i = 0; i < 20; i++) {
            Sms sms = new Sms().setName("张三" + i).setMobile("123456789" + i).setContent("你好，世界！" + i);
            channel.basicPublish("", RabbitConstant.QUEUE_SMS, null, JSONUtil.toJsonStr(sms).getBytes());
        }
        channel.close();
        connection.close();
